<template>
    <div class="content-body w-75">
        <h2 class="col-12 text-center fw-bold text-white">Pusher</h2>
        <div class="row mt-3">
...
export default {
    ...
    mounted() {
        if (
            import.meta.env.VITE_BROADCAST_CONNECTION === 'pusher'
            && import.meta.env.VITE_BROADCAST_DRIVER === 'pusher'
        ) {
            const channel = window.Echo.channel('orders_status');
